    ...
    const fetchExchangeRates = useCallback(async (forceRefresh = false) => {
        ...
        try {
            ...
            if (data.result === 'success' && data.conversion_rates) {
                ...
                localStorage.setItem('exchange-rates', JSON.stringify(data.conversion_rates));
...
export function useUserProfile() {
    const { profile, updateProfile, isLoading, error, fetchProfile } = useSettings();
...
export function usePreferences() {
    const { preferences, updatePreferences, isLoading, error, fetchPreferences } = useSettings();
